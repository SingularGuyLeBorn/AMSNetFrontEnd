...
export const translations: { [key: string]: TranslationSet } = {
  zh: {
    ...
    delete: '删除',
    saveAll: '导出全部 (ZIP)',
    chooseJsonName: '选择或创建组件 ',
    chooseJsonType: '选择或创建类型 ',
    noFile: '没有可操作的文件',
    dataExplorer: '数据浏览',
    settings: '设置',
    annotations: '标注列表',
    ...
    kgSyncSuccess: '同步成功',
    kgSyncFail: '同步失败',
    kgNodeNotFound: '在知识图谱中未找到该电路。请添加属性以创建。',
    kgNodeFound: '电路已找到，属性已加载。',
    kgDetails: '电路详情',
    noDetails: '无详情可显示',
  },
  en: {
    ...
    chooseJsonName: 'Choose or Create Component ',
    chooseJsonType: 'Choose or Create Type ',
    ...
    componentAdded: 'Component %s has been automatically added',
    ...
    typeAdded: 'Type %s has been automatically added',
    knowledgeGraph: 'Knowledge Graph',
    kgAutoSync: 'Knowledge Graph Properties',
    kgCircuitName: 'Circuit Name',
    kgStatus: 'Sync Status',
    kgLastSync: 'Last Sync',
    kgSyncing: 'Syncing...',
    kgSaving: 'Saving circuit properties...',
    kgSyncSuccess: 'Sync successful',
    kgSyncFail: 'Sync failed',
    kgNodeNotFound: 'Circuit not found in KG. Add properties to create it.',
    kgNodeFound: 'Circuit found, properties loaded.',
    kgDetails: 'Circuit Details',
